...
class DataConfig:
    ...
    def get_data_config(self, data_name):
        ...
        if data_name == 'LEVIR':
            ...
            self.root_dir = './CDData/LEVIR-CD-256/'
        elif data_name == 'DSIFN':
            self.label_transform = "norm"
            self.root_dir = './CDData/DSIFN-CD-256/'
        elif data_name == 'WHU':
            self.label_transform = "norm"
            self.root_dir = './CDData/WHU-CD-256/'
        elif data_name == 'CDD':
            self.label_transform = "norm"
            self.root_dir = './CDData/CDD-CD-256/'
        elif data_name == 'TYPO':
            self.label_transform = "norm"
            self.root_dir = './CDData/TYPO/'
